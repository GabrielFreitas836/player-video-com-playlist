...
class NormalVideo extends Video {
    play() { console.log(`Tocando vídeo normal: ${this.titulo}`); }
    pause() { console.log("Vídeo normal pausado."); }
    stop() { console.log("Vídeo normal parado."); }
    info() { return `Normal: ${this.titulo}`; }
}
